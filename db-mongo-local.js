/**
 * JB IMPORTES - Banco de Dados MongoDB Local
 * Este arquivo fornece funções para gerenciar o banco de dados através do MongoDB local
 */

const { MongoClient, ObjectId } = require('mongodb');

// URL de conexão do MongoDB local
const MONGODB_URI = 'mongodb://localhost:27017/jbimportes';
